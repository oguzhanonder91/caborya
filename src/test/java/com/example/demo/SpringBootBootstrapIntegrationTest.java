...
@SpringBootTest(classes = {CaboryaApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
public class SpringBootBootstrapIntegrationTest {
	...
	public void whenUpdateCreatedBook_thenUpdated() {
		...
		book.setId(location.split("api/books/")[1]);
